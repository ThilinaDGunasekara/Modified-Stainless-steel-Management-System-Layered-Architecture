...
public class SearchItemController {
    ...
    SearchItemBO searchItemBO = BOFactory.getInstance().getBO(BOTypes.SEARCH_ITEM);
    ...
    public void initialize(){
        ...
        txtSearch_id.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                ...
                try {
                    List<ItemDTO> itemDTOS = searchItemBO.searchItem(searchText);
                    ObservableList<ItemTM> items1 = tblList.getItems();
                    items1.clear();
                    for (ItemDTO itemDTO : itemDTOS) {
                        items1.add(new ItemTM(
                                itemDTO.getItemCode(),
